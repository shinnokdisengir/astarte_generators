...
defmodule Astarte.Core.Generators.Triggers.SimpleEvents.SimpleEvent do
  @moduledoc """
  This module provides generators for Astarte Triggers SimpleEvents SimpleEvent.

  See https://docs.astarte-platform.org/astarte/latest/060-triggers.html#simpleevent-payloads
  ...
  @doc """
  Generates a valid Astarte Triggers SimpleEvents SimpleEvent
  """
  def simple_event(params \\ []) do
    params gen all timestamp <- timestamp(), params: params do
      %SimpleEvent{
        timestamp: timestamp
      }
    end
  ...
  defp timestamp(), do: Timestamp.timestamp()
end
