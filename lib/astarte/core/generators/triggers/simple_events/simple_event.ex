...
defmodule Astarte.Core.Generators.Triggers.SimpleEvents.SimpleEvent do
  ...
  defp simple_trigger_id, do: one_of([nil, binary()])
  defp parent_trigger_id, do: one_of([nil, binary()])
  defp device_id, do: one_of([nil, DeviceGenerator.encoded_id()])
  defp realm, do: one_of([nil, RealmGenerator.realm_name()])
  ...
  defp timestamp, do: one_of([nil, TimestampGenerator.timestamp(unit: :microsecond)])
end
